...
<!-- ![flickr: WendyHarris1955 'COVID-19 Antibody test'](covid-19-antibody-test.png){fig-alt="flickr: WendyHarris1955 'COVID-19 Antibody test' packs and information leaflets"} <!-- https://www.flickr.com/photos/48028479@N00/50700002992/in/photolist-2kfbLwC-2ks8vkP-2ko372t-2kpUzV5-2koAFms-2johfMp-2iNGvm2-2iJwfLi-2iHUmdY-2kboEzD-2jQYned-2iFB92k-2iJwg1m-2jNnmPN-2iJwfX5-2jYWpH7-2knXHGC-2iJuBMe-2jNxBM6-2jLFqcL-2jjMAs3-2kmBiJn-2jfGre3-pFrJ2H-2iNstgP-2iFV9CP-2jmcrQZ-2j9zUv2-2iQpJ3v-2jKVgeC-2kkFN53-2izv75k-2j3wiC3-2jKVgfV-2knMfq7-2k5d4t6-2iJuBLs-2iNK4S3-2iNj2su-2jb5YPJ-2jwceQD-2iERnY6-2iPRZtd-2iUt6r3-2iEVKNV-2jEadxx-2j8V3FT-2iVyj83-2jxWUTb-2iPQdHE --> -->
...
<!-- <!-- https://lancasteruni.eu.qualtrics.com/Q/MyProjectsSection --> -->
...
<!-- <!-- ## We need to try to keep distinctions clear --> -->

<!-- <!-- -   Your theoretical or formal model of the psychology --> -->

<!-- <!-- -   Is different from your statistical model --> -->

<!-- <!-- -   And the causes or effects you hypothesize --> -->

<!-- <!-- -   Are different from the associations you do or do not observe --> -->

<!-- <!-- -   Given the measurements that do or do not validly reflect constructs --> -->
...
<!-- ## A scatterplot is a useful way to examine if the values of two or more variables vary together {.smaller} -->
...
<!-- ![Rammstein concert crowd surfing; flickr, CC, Anirudh Koul](Rammstein_Concert_Crowd_Surfing___Rammstein_Concert_Crowd_Surfing-flickr-Anirudh-Kohl.png){fig-alt="Photograph from 2011 Rammstein concern: man in glittery suit, in a boat, carried by a crowd of people"} -->
...
<!-- ```{r free-speech-jeremy-brooks-1, echo=FALSE, out.width='80%', fig.cap="flickr: Jeremy Brooks 'Free speech fear free'"} -->
<!-- knitr::include_graphics("free-speech-jeremy-brooks.png") -->
<!-- # https://flickr.com/photos/jeremybrooks/4014811564/ -->
<!-- ``` -->
