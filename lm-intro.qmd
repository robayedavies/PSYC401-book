...
You will see, next, the lectures we share to explain the concepts you will learn about, and the practical data analysis skills you wil develop (@sec-lm-intro-lectures). Then you will see information about the practical materials you can use to build and practise your skills (@sec-lm-intro-practical).
...
2. In @sec-lm-dev, we share materials to extend your capacity to use linear models, to answer more and different kinds of research questions.
:::
