...
>**Q.2.** Then edit the appearance of the background using `theme_bw()`.
...
>**Q.4.** Then set the x-axis limits using `x.lim()`.
...
>**Q.5.** Then add annotation: a vertical line to show the mean value of 
...
##### Practical Task 10 -- We can use linear model results to make predictions
