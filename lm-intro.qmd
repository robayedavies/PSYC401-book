# Introduction to visualization {#sec-lm-intro-intro}
...
<!-- ## Week 9: Focus on the linear model {background-color="lightblue"} -->
...
<!-- ## Predicted association as *expected* change in average outcome {.smaller} -->
...
<!-- ## The sentence structure of models in R {background-color="lightblue"} -->
...
<!-- ## What the prediction errors look like {.smaller} -->
...
<!-- ## Identifying the key information in the linear model results {.smaller} -->
...
<!-- ## For the effect of vocabulary (SHIPLEY), we have: {.smaller} -->
...
<!-- ## R-squared -- what is it? -- an indicator of the proportion of outcome variation we can predict {.smaller} -->
...
<!-- ## Reporting the results of a linear model {.smaller} -->
