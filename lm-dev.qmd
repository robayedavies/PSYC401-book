...
we show you how to do everything you need to do in the practical workbook (see @sec-lm-dev-practical-workbook). The guide comprises an .R file `401-lm-intro-how-to.R` with code and advice.
