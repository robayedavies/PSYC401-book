...
::: callout-tip
## Further information you can explore
In producing prediction plots, we are using functions from the `{ggefects}` library. Can you locate online information about working with the library functions?
...
##### Practical Task 8 -- Fit a linear model to examine what variables predict outcome
