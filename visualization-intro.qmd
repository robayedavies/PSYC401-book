...
<!-- # This differs slightly from the method used by the boxplot() function, and may be apparent with small  -->
<!-- # samples. See boxplot.stats() for more information on how hinge positions are calculated for boxplot(). -->
<!-- #  -->
<!-- # The upper whisker extends from the hinge to the largest value no further than 1.5 * IQR from the  -->
<!-- # hinge (where IQR is the inter-quartile range, or distance between the first and third quartiles).  -->
...
<!-- # -- A.3. -- The web page: -->
<!-- # https://ggplot2.tidyverse.org/reference/geom_boxplot.html   -->
<!-- # -- includes example code like this:   -->
<!-- # p <- ggplot(mpg, aes(class, hwy)) -->
<!-- # p + geom_boxplot() -->
...
<!-- # -- A.5. -- You can do a search like you have been doing -- with the words: -->
<!-- # ggplot reference geom_jitter   -->
<!-- # -- hint: Q.5 -- That will get you results including this one: -->
<!-- # https://ggplot2.tidyverse.org/reference/geom_jitter.html   -->
<!-- # -- which says: -->
...
<!-- # -- A.6. -- Overplotting refers to where points (or other objects) are printed -->
...
<!-- # -- 2 -- plus a scatterplot showing individual vocabulary scores for each person -->
<!-- # in the data-set -->
<!-- # -- A.7. -- The example code can be edited to:    -->
<!-- # p <- ggplot(data = study.two, aes(x = EDUCATION, y = SHIPLEY)) -->
<!-- # p + geom_boxplot(outlier.shape = NA) + geom_jitter(width = 0.2) -->
...
<!-- # -- A.8. -- The plot indicates that the median vocabulary score is higher -->
<!-- # for people who report Higher education compared to people who report Further -->
<!-- # education or people who report Secondary education -->
<!-- # -- hint: We can see this because the middle line in the boxes, representing -->
<!-- # the median score for people in each education level group, is higher for  -->
<!-- # for people who report Higher education  -->

<!-- # -- Q.9. -- What does the plot tell you about the individual i.e. per-person -->
<!-- # vocabulary (SHIPLEY) score recorded for people in the study.two dataset -->
<!-- # who report different education levels? -->
<!-- # -- A.9. -- The plot indicates a lot of variability in the individual scores -->
<!-- # -- The distributions of scores appears to have similar wide ranges in each -->
<!-- # group -->
...
<!-- # -- A.10. -- The explanation, in short is that: -->
<!-- # -- conventional visualizations like bar plots can be misleading -->
<!-- # -- showing raw data with statistical summaries helps the viewer to see both -->
<!-- # statistical summary information and raw outcomes -->
...
<!-- # -- A.11. -- A good example tutorial is the one written by Cedric Scherer: -->
<!-- # https://www.cedricscherer.com/2021/06/06/visualizing-distributions-with-raincloud-plots-and-how-to-create-them-with-ggplot2/ -->
<!-- # -- It is a bit simpler here so I focus on this one: -->
<!-- # https://z3tt.github.io/Rainclouds/   -->
...
<!-- # -- hint: Task 6 -- Copy a chunk of example code and paste it directly into -->
...
<!-- # -- A.12. -- You need to change the data, and the aesthetic mappings -- from  -->
<!-- # something like this: -->
<!-- #  -->
<!-- # ggplot(iris, aes(Species, Sepal.Width)) +  -->
<!-- #   ggdist::stat_halfeye(adjust = .5, width = .7, .width = 0, justification = -.2, point_colour = NA) +  -->
...
<!-- # -- to this: -->
<!-- #  -->
<!-- # ggplot(data = study.two, aes(x = EDUCATION, y = SHIPLEY)) +  -->
<!-- #   ggdist::stat_halfeye(adjust = .5, width = .7, .width = 0, justification = -.2, point_colour = NA) +  -->
<!-- #   geom_boxplot(width = .2, outlier.shape = NA) +  -->
<!-- #   geom_jitter(width = .05, alpha = .3) -->
...
<!-- # -- A.13. -- You can find instructions e.g. here -->
...
<!-- # https://ggplot2.tidyverse.org/reference/scale_brewer.html -->
<!-- # -- hint: Q.14. -- You may need to edit the aesthetic mappings to instruct R to map colour (lines) and fill -->
<!-- # to the categorical variable or factor we are working with -->
<!-- ggplot(data = study.two, aes(x = EDUCATION, y = SHIPLEY,  -->
...
<!-- # -- A.15. -- Again, we are asking you to do a key words search. If you do, the results may include: -->
